...
<b><?php echo lang('ManageDepartments');?></b><p> </p>
...
<form action="index.php" method="post" name="adminForm">
	...
	<table class="adminlist">
		...
		{
			$row =& $this->rows[$i];
			$checked = JHTML::_('grid.id', $i, $row->department_id);
			$link = JFilterOutput::ampReplace('index.php?option=' . JRequest::getCmd('option') . '&view=department&task=edit&cid[]=' . $row->department_id);
			?>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<a href="<?php echo $link; ?>"><?php echo $row->dname; ?></a>
				</td>
				<td align="center"> 
