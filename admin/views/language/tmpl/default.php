...
<b><?php echo lang('ManageLanguages');?></b><p> </p>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo lang('LanguageName');?></th>
				<th><?php echo lang('Localized');?></th>
		...
		for($i=0,$n=count($this->rows); $i<$n; $i++)
		{
			...
			$link = JFilterOutput::ampReplace('index.php?option=' . JRequest::getCmd('option') . '&view=language&task=edit&cid[]=' . $row->id);
			?>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<a href="<?php echo $link; ?>"><?php echo $row->langname; ?></a>
				</td>
				<td>
					<?php echo $row->localized; ?>
				</td>
				<td align="center"> 
					<?php echo $row->id; ?>
				</td>
