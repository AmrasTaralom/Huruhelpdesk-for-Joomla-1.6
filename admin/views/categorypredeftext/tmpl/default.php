...
<b><?php echo lang('ManageCategories');?></b><p> </p>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo lang('Predeftext');?></th>
			</tr>
		</thead>
		...
		for($i=0,$n=count($this->rows); $i<$n; $i++)
		{
			...
			$link = JFilterOutput::ampReplace('index.php?option=' . JRequest::getCmd('option') . '&view=categorypredeftext&task=edit&cid[]=' . $row->id);
			?>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center"> 
					<a href="<?php echo $link; ?>"><?php echo $row->category_id; ?></a>
				</td>
				<td>
					<?php echo $row->predeftext; ?>
				</td>
			</tr>
			<?php 
			$k = 1 - $k;
