...
<b><?php echo lang('ManageStatuses');?></b><p> </p>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="75"><?php echo lang('Rank');?></th>
				<th><?php echo lang('StatusName');?></th>
		...
		for($i=0,$n=count($this->rows); $i<$n; $i++)
		{
			...
			$link = JFilterOutput::ampReplace('index.php?option=' . JRequest::getCmd('option') . '&view=status&task=edit&cid[]=' . $row->id);
			?>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<a href="<?php echo $link; ?>"><?php echo $row->sname; ?></a>
				</td>
				<td align="center"> 
					<?php echo $row->id; ?>
				</td>
