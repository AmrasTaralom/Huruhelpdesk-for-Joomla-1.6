...
class HuruHelpdeskModelCategorypredeftext extends JModel
{
	var $_total = null;
	...
	function _buildQuery()
	{
		if(!$this->_query)
		{
			...
			$this->_query = "SELECT * FROM #__huruhelpdesk_categories_predeftext";
			
			if($search != '')
			{
				$fields = array('predeftext');
				$where = array();
			...
			$this->_query .= " ORDER BY predeftext ";
		}
