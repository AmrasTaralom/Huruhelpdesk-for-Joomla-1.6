...
class HuruHelpdeskModelLanguage extends JModel
{
	var $_total = null;
	...
	function _buildQuery()
	{
		if(!$this->_query)
		{
			...
			$this->_query = "SELECT * FROM #__huruhelpdesk_language";

			if($search != '')
			{
				$fields = array('langname','localized');
				$where = array();
