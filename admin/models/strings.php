...
class HuruHelpdeskModelStrings extends JModel
{
	var $_total = null;
	...
	function _buildQuery()
	{
		...
		if(!$this->_query)
		{
			...
			$this->_query = "SELECT * FROM #__huruhelpdesk_langstrings";
			
			$this->_query .= " WHERE lang_id=" . safe($cid[0]);

			if($search != '')
			{
				$fields = array('variable', 'langtext');
				$where = array();
