...
class HuruHelpdeskControllerDepartment extends JController
{
	function add()
	{
		JToolBarHelper::save();
	...
	function display() //display list of all departments
	{
	...
	function displaySingle($type) //display a single Department that can be edited
	{
		JRequest::setVar('view', 'departmentedit');
	...
	function remove()
	{
		...
		$this->setRedirect('index.php?option=' . $option . '&view=department', 'Department' . $s . ' deleted.');
	}
...
$controller = new HuruHelpdeskControllerDepartment();
