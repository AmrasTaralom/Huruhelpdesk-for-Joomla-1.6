...
class HuruHelpdeskControllerCategory extends JController
{
	function add()
	{
		JToolBarHelper::save();
	...
	function remove()
	{
		...
		$this->setRedirect('index.php?option=' . $option . '&view=category', 'Categor' . $s . ' deleted.');
	}
...
$controller = new HuruHelpdeskControllerCategory();
