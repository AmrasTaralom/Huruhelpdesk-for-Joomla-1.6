...
(582, 2, 'Close', 'Schließen'),
(583, 2, 'CloseDate', 'Datum der Schließung'),
...
(624, 2, 'SelectCategory', 'Kategorie auswählen'),
(625, 2, 'SelectDepartment', 'Abteilung auswählen'),
(626, 2, 'SelectUser', 'Nutzer auswählen'),
(627, 2, 'AssignedTo', 'Zugewiesen an'),
(628, 2, 'Solution', 'Lösung'),
(629, 2, 'StartDate', 'Start-Datum'),
(630, 2, 'Status', 'Status'),
(631, 2, 'Subject', 'Betreff'),
(632, 2, 'Submit', 'Absenden'),
(633, 2, 'SubmitNewProblem', 'Neues Ticket eröffnen'),
(634, 2, 'SupportRep', 'Bearbeiter'),
(635, 2, 'Time', 'Zeit'),
(636, 2, 'TimeSpent', 'benötigte Zeit'),
(637, 2, 'Title', 'Titel'),
(638, 2, 'Total', 'Gesamt'),
(639, 2, 'User', 'Nutzer'),
...
(655, 2, 'ErrorSavingProblem', 'Fehler beim Speichern: Ungültiges oder fehlendes benötigtes Feld.'),
...
(666, 2, 'Reset', 'Zurücksetzen'),
(667, 2, 'To', 'An'),
(668, 2, 'SearchText', 'Suchtext'),
(669, 2, 'Browse', 'Durchblättern'),
...
(676, 2, 'AvailableReports', 'Verfügbare Reports'),
...
(725, 2, 'AllowUserSelectOnNewCases', 'Nutzer darf bei neuen Tickets Nutzernamen wählen'),
...
(730, 2, 'Anyone', 'Jeder'),
(731, 2, 'DefaultPriority', 'Standard-Priorität'),
(732, 2, 'PagerPriority', 'Pager-Priorität'),
...
(753, 2, 'AvailableSubstitutions', 'verfügbare Ersetzungen'),
...
(759, 2, 'ManagePriorities', 'Prioritäten verwalten'),
(760, 2, 'PriorityName', 'Prioritätsbezeichnung'),
(761, 2, 'EditPriority', 'Priorität bearbeiten'),
...
(775, 2, 'SyncJoomlaUsersConfirm', 'Importiert die Joomla!-Nutzer in Huru Helpdesk. An den Joomla!-Tabellen wird keine Änderung vorgenommen.'),
(776, 2, 'EditUser', 'Nutzer bearbeiten'),
(777, 2, 'IsUser', 'Nutzer'),
(778, 2, 'IsRep', 'Bearbeiter'),
(779, 2, 'IsAdmin', 'Administrator'),
(780, 2, 'ViewReports', 'Reports ansehen'),
(781, 2, 'UserSuperAdminNote', '(Bemerkung: Diese Einstellung wird für Joomla! Super-Administratoren ignoriert. Diese sind immer auch Huru Helpdesk-Admins).'),
(782, 2, 'DefaultAssignment', 'Standard der Kategorie'),
(783, 2, 'PageTitle', 'Rising Gods Ticket-System'),
(784, 2, 'SelectOverride', 'Überschreibt obige Kontaktinformationen'),
(785, 2, 'CannotDeleteClosedStatus', 'Der geschlossen-Status kann nicht gelöscht werden'),
(786, 2, 'Go', 'Go'),
(787, 2, 'ProblemDeleted', 'Ticket gelöscht'),
(788, 2, 'ProblemNotDeleted', 'Fehler beim Löschen des Tickets'),
(789, 2, 'DeleteProblem', 'Lösche Ticket #'),
(790, 2, 'Delete', 'Löschen'),
(791, 2, 'ProblemCreated', 'Ticket erstellt'),
(792, 2, 'AttachFileToNote', 'Datei anhängen'),
(793, 2, 'Attachment', 'Dateianhang'),
(794, 2, 'AttachmentFileNoteFound', 'Dateianhang nicht gefunden'),
(795, 2, 'DefaultFileAttachmentNote', 'Datei angehängt'),
...
(799, 2, 'FileTooLarge', 'Datei zu groß'),
(800, 2, 'UnknownError', 'Unbekannter Fehler'),
(801, 2, 'NotificationSenderName', 'Absender der Benachrichtigung'),
(802, 2, 'AllowFileAttachments', 'Dateianhänge erlauben'),
(803, 2, 'AllowedAttachmentExtensions', 'Erlaubte Dateiendungen'),
(804, 2, 'ExtensionExample', 'Komma-getrennte Liste erlaubter Dateiendungen (mit führendem Punkt) [z.B: .jpg,.png,.txt]'),
(805, 2, 'MaximumAttachmentSize', 'Maximale Anhang-Größe'),
(806, 2, 'Bytes', 'bytes'),
(807, 2, 'AttachmentSizeWarning', 'Das Maximum beträgt 16MB.  PHP könnte aber auf weniger eingestellt sein (siehe PHP.ini).'),
(808, 2, 'AttachmentDownloadPermissions', 'Herunterladen von Dateianhängen erlauben'),
(809, 2, 'AttachmentDeleted', 'Dateianhang gelöscht'),
(810, 2, 'AttachmentNotDeleted', 'Dateianhang löschen fehlgeschlagen'),
(811, 2, 'MaximumAttachmentAge', 'Lösche Dateianhänge automatisch nach'),
(812, 2, 'SetToZero', 'Auf 0 setzen um Auto-Löschung zu deaktivieren.'),
(813, 2, 'MailFullname', 'Joomla!-Name des Ticket-Erstellers'),
(814, 2, 'NotifyAdminOnNewCase', 'Benachrichtigung für alle Tickets an'),
...
(819, 2, 'FileAttachments', 'Dateianhänge'),
(820, 2, 'DisplayedFields', 'Angezeigte Spalten'),
(821, 2, 'DefaultDepartment', 'Standardabteilung'),
(822, 2, 'DefaultCategory', 'Standardkategorie'),
(823, 2, 'Show', 'Anzeigen'),
(824, 2, 'Set', 'Setzen'),
(825, 2, 'IfNotSetable', 'Wenn nicht sichbar/setzbar für Jeden wird oben ein Standardwert für dieses Feld benötigt.'),
